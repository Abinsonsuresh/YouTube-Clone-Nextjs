                ...
                <div>
                    <div className="flex items-center gap-5">
                        <form className='flex items-center relative' action="">
                            ...
                            <div className='md:bg-[#262626] hidden md:flex p-3 absolute right-0 rounded-r-full'>
                        ...
                        <div className='bg-[#262626] hidden md:flex rounded-full w-10 h-10  items-center justify-center p-2'>
                            <p><AiFillAudio size={20} /></p>
                        </div>
                    </div>
                </div>
                <div className='flex items-center gap-2'>
                    <div className='bg-[#262626] rounded-full  w-10 h-10 hidden md:flex items-center justify-center p-2'>
